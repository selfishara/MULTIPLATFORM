...
fun ExerciseDetailScreen(
    ...
    val exercise = fakeExercises.find { it.id == exerciseId } ?: return
    val isInRoutine = RoutineState.routine.any { it.id == exercise.id }

    Column(modifier = Modifier.fillMaxSize()) {
        TopBar(
            title = exercise.name,
            subtitle = exercise.muscleGroup.displayName,
            showBackIcon = true,
            onBackClick = onBack
        )
